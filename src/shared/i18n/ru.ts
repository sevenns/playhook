...
export const ru: Partial<Record<MessageKey, string>> = {
  ...
  'metadata.candidates': 'Какая это игра?',
  'metadata.searchAgain': 'Искать заново',
  'metadata.categories': 'Что подтянуть',
  ...
  'metadata.heroExists': 'У игры уже есть фоны',
  'metadata.heroAppend': 'Добавить к ним',
  'metadata.heroReplace': 'Заменить все',
  'metadata.appliedPartly': 'Применено. Не поместилось: {count}.',
  'metadata.albums': 'Саундтреки',
  'metadata.tracks': 'Треки',
