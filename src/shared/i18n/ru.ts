...
export const ru: Partial<Record<MessageKey, string>> = {
  ...
  'osk.done': 'Готово',
  'osk.cancel': 'Отмена',
  'osk.legend': 'X - стереть, Y - регистр, LB/RB - раскладка, B - отмена',
  'picker.title': 'Выбор',
  ...
  'picker.legendMulti': 'X - отметить, A - выбрать, B - на уровень выше, влево/вправо - сменить колонку',
  ...
  'gameSettings.schemaVersion': 'Версия манифеста',
  'gameSettings.source': 'Источник',
  ...
  'gameSettings.copyToPcHint': 'Игра копируется на этот ПК и запускается оттуда; на карте она остаётся.',
  ...
  'gameSettings.installCustomHint': 'Свой установщик запускаете вы, поэтому повышение прав запрашивать нам нечего.',
  ...
  'gameSettings.save': 'Сохранить и применить',
  'gameSettings.reset': 'Отменить изменения',
  ...
  'gameSettings.confirmReset': 'Отменить изменения и перечитать манифест?',
  ...
  'errors.steamBusyOther': 'В Steam сейчас качается или удаляется другая игра. Дождитесь завершения.',
