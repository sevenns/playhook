...
export const en = {
  ...
  'settings.sectionMetadata': 'Game metadata',
  ...
  'osk.legendDone': 'RT - done',
  'osk.legendCancel': 'B - cancel',
  'picker.title': 'Choose',
  'picker.cancel': 'Cancel',
  'picker.up': 'Up one level',
  'picker.useThisFolder': 'Use this folder',
  'picker.empty': 'Nothing here.',
  'picker.legend': 'A - open or choose, B - up one level, Y - actions, left/right - switch column',
  ...
  'gameSettings.executableCopyHint':
    'Relative to the game folder on the card that gets copied (the field below).',
  'gameSettings.executableInstallHint': 'Relative to the folder the installer installs into.',
  'gameSettings.pcExecutable': 'Executable',
  ...
  'gameSettings.saveOnCardHint': 'Saves are copied here once you finish playing.',
  ...
  'gameSettings.launchTimeoutHint':
    'How long to wait for the game to appear after it is started before giving up on it.',
  'gameSettings.killTimeoutHint':
    'How long a force-close waits for the game to actually die before reporting it did not.',
  ...
  'gameSettings.cannotSave':
    'Fix the problems marked above to save. Every field with one is outlined on the left.',
  ...
  'metadata.findOnline': 'Find online',
  'metadata.searchTitle': 'Search for a game',
  'metadata.searching': 'Searching',
  'metadata.nothingFound': 'Nothing found. Try another title.',
  'metadata.candidates': 'Which game is it?',
  'metadata.searchAgain': 'Search again',
  'metadata.categories': 'What to fetch',
  ...
  'metadata.applySelected': 'Apply ({count})',
  'metadata.clearPicked': 'Clear ticked ({count})',
  'metadata.loadMore': 'Load more',
  'metadata.filterSource': 'Source',
  'metadata.filterSize': 'Size',
  'metadata.filterAny': 'Any',
  ...
  'metadata.heroExists': 'This game already has backgrounds',
  'metadata.heroAppend': 'Add to them',
  'metadata.heroReplace': 'Replace all of them',
  'metadata.appliedPartly': 'Applied. {count} did not fit and were skipped.',
  'metadata.albums': 'Soundtracks',
  'metadata.tracks': 'Tracks',
  'metadata.noAlbums': 'No soundtrack found for this game.',
  'metadata.noTracks': 'This album has no tracks.',
  'metadata.listen': 'Listen',
  'metadata.stopListen': 'Stop',
  'metadata.pickAlbum': 'Choose an album on the left.',
  'metadata.useTrack': 'Apply',
  ...
  'metadata.badRequest': 'Could not apply that choice.',
  'metadata.noDescriptions': 'No description is available for this game.',
